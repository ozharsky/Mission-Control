    ...
    container.innerHTML = `
      <div class="welcome-bar">
        <div class="welcome-content">
          <div class="welcome-greeting">💰 Revenue</div>
        ...
        <button class="btn btn-sm btn-secondary" onclick="document.getElementById('revenueFileInput').click()">📁 Import</button>
      </div>
      
      <input type="file" id="revenueFileInput" accept=".csv" style="display: none;" onchange="handleRevenueFileSelect(this)">
      
      <!-- Key Metrics -->
      <div class="metrics-grid revenue-metrics">
      ...
      <div class="card">
        <div class="card-header">
          <div class="card-title">🎯 This Month's Goals</div>
          <span class="goal-subtitle">Based on your ${history.length > 3 ? '3-month average + 20%' : 'starter goals'}</span>
        </div>
      ...
      ${history.length > 0 ? `
        ...
        <div class="card">
          ...
          <div class="chart-container" style="height: ${window.innerWidth < 768 ? '280px' : '380px'};">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <span class="history-count">${history.length} months tracked</span>
          </div>
      ...
      ` : `
        <div class="empty-state">
          ...
          <button class="btn btn-primary" onclick="document.getElementById('revenueFileInput').click()">📁 Import Orders CSV</button>
        </div>
      `}
    `
